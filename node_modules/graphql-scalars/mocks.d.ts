...
export declare const DateTime: () => Date;
...
export { URLMock as URL, NonNegativeInt as UnsignedInt, NonNegativeFloat as UnsignedFloat, BigIntMock as Long, BigIntMock as BigInt, };
